...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('guest:admin')->group(function () {
        ...
        // img upload
         // ADD THIS LINE AFTER YOUR BLOG ROUTES:
        // Route::post('/blogs/upload-image', [\App\Http\Controllers\Admin\BlogController::class, 'uploadImage'])
        // ->name('blogs.upload-image');

    //     Route::post('ckeditor/upload', [App\Http\Controllers\Admin\BlogController::class, 'ckeditorUpload'])
    // ->name('ckeditor.upload');  // ← shorter name, group will make it admin.ckeditor.upload
